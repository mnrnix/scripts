...
hwclock --systohc
pacman -Syyy --noconfirm python reflector
...
#part3
sudo pacman -Syyy --noconfirm bspwm sxhkd dmenu dunst libnotify jq net-tools bind inetutils htop screen tmux neofetch screenfetch \
